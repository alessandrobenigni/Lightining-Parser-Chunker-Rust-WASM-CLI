#!/usr/bin/env python3
"""Benchmark Unstructured.io on the standard corpus.

Requires: pip install unstructured

Processes each file with unstructured's partition function and reports
timing metrics in CSV format compatible with the report generator.

Usage:
    python benchmarks/bench_unstructured.py [--corpus benchmark-corpus]
"""
...
def check_import():
    try:
        ...
        print("ERROR: unstructured not installed. Run: pip install unstructured")
        print("Skipping Unstructured benchmark.")
        return False
...
def main():
    parser = argparse.ArgumentParser(description="Benchmark Unstructured.io")
    ...
    results_file = results_dir / "unstructured-timings.csv"

    print("=== Unstructured.io Benchmark ===")
    ...
    print("=== Unstructured.io Benchmark Complete ===")
